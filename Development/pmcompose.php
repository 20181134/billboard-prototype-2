        ...
        <main>
            <div class="contents">
                ...
                <div class="tl">
                    ...
                    <form action="./pm-output.php" method="post">
                        To: <input type="text" name="userid"><br>
                        Subject: <input type="text" name="subject"><br>
                        Main Message: <textarea name="mainpm"></textarea>
                        <input type="submit" value="Send">
                    </form>
                    <p>KEEP IN MIND: Do not send any personal information or anything important. </p>
                </div>
            </div>
        </main>
    </body>
